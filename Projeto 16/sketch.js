...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    //move espada com o mouse
    knife.y = World.mouseY;
    knife.x = World.mouseX;

    //Se a espada tocar na fruta
    if (fruitGroup.isTouching(knife)) {
      fruitGroup.destroyEach();

      //Adicionar som da faca 
      ...
      //Muda para o estado final se a espada tocar o inimigo
      if (monsterGroup.isTouching(knife)) {
        ...
        //Muda a animação da espada para fim de jogo e redefina sua posição
